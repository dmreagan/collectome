...
angular
  ...
  .factory('exhibitConfigFactory', () => {
    ...
    exhibitConfigFactory.config =
   {
     ...
     content: [
       { id: 'content1', title: 'Information Technology News', url: 'https://itnews.iu.edu/' },
       ...
       { id: 'content3', title: 'School of Informatics, Computing and Engineering', url: 'http://www.sice.indiana.edu/' },
     ...
     layout: {
       ...
       containers: [
         {
           id: 'container1', originX: 0, originY: 0, sizeX: 1, sizeY: 2,
         },
         {
           id: 'container2', originX: 1, originY: 0, sizeX: 1, sizeY: 2,
         },
         {
           id: 'container3', originX: 2, originY: 0, sizeX: 2, sizeY: 2,
         },
       ],
